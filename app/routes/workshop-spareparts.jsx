      ...
      <header className="bg-slate-900/80 backdrop-blur-xl border-b border-cyan-500/20 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link to="/workshop-spareparts" className="text-cyan-400">Sparepart</Link>
            <Link to="/spare-parts" className="text-gray-300 hover:text-white">Marketplace</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="bg-slate-800/60 border border-cyan-500/20 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            ...
            <input value={marketItem.price} onChange={(e)=>setMarketItem({...marketItem,price:parseInt(e.target.value||"0")})} type="number" placeholder="Harga (Rp)" className="bg-slate-800 border border-slate-600 rounded-lg px-3 py-2 text-white" />
            <input value={marketItem.stock} onChange={(e)=>setMarketItem({...marketItem,stock:parseInt(e.target.value||"0")})} type="number" placeholder="Stok" className="bg-slate-800 border border-slate-600 rounded-lg px-3 py-2 text-white" />
